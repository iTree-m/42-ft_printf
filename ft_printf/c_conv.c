...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/11 15:54:00 by ichejra           #+#    #+#             */
/*   Updated: 2020/01/16 11:49:02 by ichejra          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static void	zero_and_char(const char **s, t_struct *var)
{
	if (var->secondchar == 1)
	{
		print_zero(s, var);
...
static void	min_and_char(const char **s, t_struct *var)
{
...
static void	prec_and_char(const char **s, t_struct *var)
{
	if (var->secondchar == 1)
		ft_putchar(var->ch, var);
	else if (var->secondchar == 2)
